...
class AdminController extends Controller
{
    ...
    public function ajaxListAction(Request $request)
    {
        ...
        $pagination  = (new Paginator())->setItems(count($entities), $searchParam['perPage'])->setPage(
            $searchParam['page'])->toArray();
    ...
    public function newAction()
    {
        ...
        return $this->render('BenUserBundle:admin:new.html.twig', array('entity' => $entity, 'form' =>
            $form->createView()));
    }
